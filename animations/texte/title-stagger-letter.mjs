...
export const staggerLetter = (delay = 0, containerTitle) => {
    ...
    setTimeout(()=> {
        const letters = document.querySelectorAll('.title-complete span');
        const tl = gsap.timeline();
        tl.to(letters, { y: 0, duration: 1, ease: "power3.inOut", stagger: { amount: 0.5 , ease: "power3.inOut" } });
    }, delay)
}
